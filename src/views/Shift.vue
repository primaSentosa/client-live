  ...
  <script>
    ...
    export default {
      ...
      methods: { 
          ...
          findLastShift(){
                      axios({
                          url: `https://server-new-adara.herokuapp.com/shift/last`,
                          method: 'get',
                          headers:{
          ...
          mulaiShift(){
                  Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          axios({
                              url: `https://server-new-adara.herokuapp.com/shift/kasir/mulai`,
                              method: 'post',
                              headers:{
                                  token : localStorage.getItem('token')
                              },
          ...
          akhiriShift(){
                  Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          axios({
                              url: `https://server-new-adara.herokuapp.com/shift/kasir/selesai`,
                              method: 'put',
                              headers:{
                                  token : localStorage.getItem('token')
                              },
