        ...
        <div class="col-12">
            <div class="main-bar border p-3" v-if="!showForm">      
                ...
                <div style="margin-top:20px">
                    ...
                    <v-tab :href="Item" @click="fetchItem()">All Item</v-tab>
                    <v-tab :href="History" @click="fetchHistory()">History</v-tab>                    


                    <!-- Item -->
                    <v-tab-item :value="Item" > 
                        <h3 style="margin-top: 10px;">Supplier Item
                    ...
                    <v-tab-item :value="History" > 
                        <h3 style="margin-top: 10px;">History Pembelian
                            <v-icon @click.stop="dialog = true" color="black" class="ml-1 mb-1">mdi-plus-circle-outline</v-icon>
                        </h3>                         
                        <!-- tabel penjualan -->
                        <v-simple-table
                ...
                <v-dialog v-model="dialog" max-width="690">
                    <v-card>
                        ...
                        <v-card-text>
                            <form @submit.prevent="addPemain(data._id)">                                        
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="namaPunggung" type="text" class="form-control">
                                </div>     
                                <div class="form-group">
                                    <label>No Punggung :</label>
                                    <input v-model="noPunggung" type="number" class="form-control">
                                </div>    
                                <div class="form-group">
                                    <label>Debut :</label>
                                    <input v-model="debut" type="text" class="form-control">
                                </div>                                       
                                <div class="form-group">
                                    <label>Umur :</label>
                                    <input v-model="age" type="number" class="form-control">
                                </div>                                                                                                                                                  
                                <button type="submit"  @click="dialog = false" class="btn btn-primary" style="margin-top: 50px"><i class="fas fa-upload" style="font-size:15px;margin-bottom:10px;"></i> Upload</button>
                            </form>
                        </v-card-text>
