           ...
           <v-simple-table
            ...
            >
                ...
                <tbody>
                    ...
                    >
                    <td @click="$router.push(`/supplier/detail/${item._id}`)">{{ item.nama }}</td>
                    <td @click="$router.push(`/supplier/detail/${item._id}`)">{{ item.alamat }}</td>
                    <td @click="$router.push(`/supplier/detail/${item._id}`)">{{ item.noHp }}</td>
                    <td @click="$router.push(`/supplier/detail/${item._id}`)">{{ item.email }}</td>               
                    <td>
                      <v-btn
                      rounded                      
                      small
