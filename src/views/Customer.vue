           ...
           <v-simple-table
            ...
            >
                ...
                <tbody>
                    ...
                    :key="item._id"                    
                    >
                    <td @click="$router.push(`/customer/detail/${item._id}`)">{{ item.nama }}</td>  
                    <td @click="$router.push(`/customer/detail/${item._id}`)">{{ item.alamat }}</td>                    
                    <td @click="$router.push(`/customer/detail/${item._id}`)">{{ item.noHp }}</td>  
                    <td @click="$router.push(`/customer/detail/${item._id}`)">{{ item.email }}</td>                    
                    <td>
                      <v-btn
                      rounded                      
                      small
